use super::super::{AddressMode, CompareFunction, FilterMode, Label};
...
#[derive(Debug)]
pub struct Sampler {
    pub(crate) inner: super::super::hal::Sampler,
}

impl Sampler {
    #[inline]
    pub(crate) fn from_hal(inner: super::super::hal::Sampler) -> Self {
        Self { inner }
    }
}
