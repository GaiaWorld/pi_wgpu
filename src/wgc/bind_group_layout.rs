...
pub enum BindingResource<'a> {
    ...
    ///
    /// Corresponds to [`crate::wgt::BufferBindingType::Uniform`] and [`crate::wgt::BufferBindingType::Storage`]
    ...
    ///
    /// Corresponds to [`crate::wgt::BindingType::Sampler`] with [`BindGroupLayoutEntry::count`] set to None.
    Sampler(&'a Sampler),
    /// Binding is backed by an array of samplers.
    ///
    /// [`Features::TEXTURE_BINDING_ARRAY`] must be supported to use this feature.
    ///
    /// Corresponds to [`crate::wgt::BindingType::Sampler`] with [`BindGroupLayoutEntry::count`] set
    /// to Some.
    SamplerArray(&'a [&'a Sampler]),
    /// Binding is backed by a texture.
    ///
    /// Corresponds to [`crate::wgt::BindingType::Texture`] and [`crate::wgt::BindingType::StorageTexture`] with
