...
impl Drop for Buffer {
    fn drop(&mut self) {
        profiling::scope!("wgc::Buffer::drop");
    }
}
...
impl Buffer {
    ...
    // TODO: map, unmap 请使用 Queue::write_buffer
    pub fn unmap(&self) {
        unimplemented!("wgc::Buffer::unmap is not implemented")
    }

    /// Destroy the associated native resources as soon as possible.
    // TODO: 只要高层不握住，自然调用 Drop 释放Buffer；此处不明白为什么要写这个函数？
    pub fn destroy(&self) {
        unimplemented!("wgc::Buffer::destroy is not implemented")
    }
}
...
impl<'a> BufferSlice<'a> {
    ...
    pub fn map_async(
        ...
        unimplemented!("wgc::BufferSlice::map_async is not implemented")
    }
    ...
    pub fn get_mapped_range(&self) -> BufferView<'a> {
        unimplemented!("wgc::BufferSlice::get_mapped_range is not implemented")
    }

    /// Synchronously and immediately map a buffer for writing. If the buffer is not immediately mappable
    /// through [`BufferDescriptor::mapped_at_creation`] or [`BufferSlice::map_async`], will panic.
    pub fn get_mapped_range_mut(&self) -> BufferViewMut<'a> {
        unimplemented!("wgc::BufferSlice::get_mapped_range_mut is not implemented")
    }
}
