...
impl AdapterShared {
    pub(super) fn describe_texture_format(
        &self,
        texture_format: crate::wgpu_types::TextureFormat,
    ) -> super::TextureFormatDesc {
        use crate::wgpu_types::TextureFormat as Tf;
        use crate::wgpu_types::{AstcBlock, AstcChannel};
...
pub(super) fn describe_vertex_format(vertex_format: crate::wgpu_types::VertexFormat) -> super::VertexFormatDesc {
    use VertexAttribKind as Vak;
    use crate::wgpu_types::VertexFormat as Vf;
...
pub fn map_filter_modes(
    min: crate::wgpu_types::FilterMode,
    mag: crate::wgpu_types::FilterMode,
    mip: crate::wgpu_types::FilterMode,
) -> (u32, u32) {
    use crate::wgpu_types::FilterMode as Fm;
...
pub fn map_address_mode(mode: crate::wgpu_types::AddressMode) -> u32 {
    match mode {
        crate::wgpu_types::AddressMode::Repeat => glow::REPEAT,
        crate::wgpu_types::AddressMode::MirrorRepeat => glow::MIRRORED_REPEAT,
        crate::wgpu_types::AddressMode::ClampToEdge => glow::CLAMP_TO_EDGE,
        crate::wgpu_types::AddressMode::ClampToBorder => glow::CLAMP_TO_BORDER,
        //crate::wgpu_types::AddressMode::MirrorClamp => glow::MIRROR_CLAMP_TO_EDGE,
    }
}

pub fn map_compare_func(fun: crate::wgpu_types::CompareFunction) -> u32 {
    use crate::wgpu_types::CompareFunction as Cf;
    match fun {
        Cf::Never => glow::NEVER,
        Cf::Less => glow::LESS,
...
pub fn map_primitive_topology(topology: crate::wgpu_types::PrimitiveTopology) -> u32 {
    use crate::wgpu_types::PrimitiveTopology as Pt;
    match topology {
...
pub(super) fn map_primitive_state(state: &crate::wgpu_types::PrimitiveState) -> super::PrimitiveState {
    ...
    super::PrimitiveState {
        ...
        front_face: match state.front_face {
            crate::wgpu_types::FrontFace::Cw => glow::CCW,
            crate::wgpu_types::FrontFace::Ccw => glow::CW,
        },
        cull_face: match state.cull_mode {
            Some(crate::wgpu_types::Face::Front) => glow::FRONT,
            Some(crate::wgpu_types::Face::Back) => glow::BACK,
            None => 0,
        },
...
pub fn _map_view_dimension(dim: crate::wgpu_types::TextureViewDimension) -> u32 {
    use crate::wgpu_types::TextureViewDimension as Tvd;
    match dim {
...
fn map_stencil_op(operation: crate::wgpu_types::StencilOperation) -> u32 {
    use crate::wgpu_types::StencilOperation as So;
    match operation {
        So::Keep => glow::KEEP,
        So::Zero => glow::ZERO,
...
fn map_stencil_ops(face: &crate::wgpu_types::StencilFaceState) -> super::StencilOps {
    super::StencilOps {
...
pub(super) fn map_stencil(state: &crate::wgpu_types::StencilState) -> super::StencilState {
    super::StencilState {
...
fn map_blend_factor(factor: crate::wgpu_types::BlendFactor) -> u32 {
    use crate::wgpu_types::BlendFactor as Bf;
    match factor {
        Bf::Zero => glow::ZERO,
        Bf::One => glow::ONE,
...
fn map_blend_component(component: &crate::wgpu_types::BlendComponent) -> super::BlendComponent {
    super::BlendComponent {
        ...
        equation: match component.operation {
            crate::wgpu_types::BlendOperation::Add => glow::FUNC_ADD,
            crate::wgpu_types::BlendOperation::Subtract => glow::FUNC_SUBTRACT,
            crate::wgpu_types::BlendOperation::ReverseSubtract => glow::FUNC_REVERSE_SUBTRACT,
            crate::wgpu_types::BlendOperation::Min => glow::MIN,
            crate::wgpu_types::BlendOperation::Max => glow::MAX,
        },
    }
}

pub(super) fn map_blend(blend: &crate::wgpu_types::BlendState) -> super::BlendDesc {
    super::BlendDesc {
...
pub(super) fn map_storage_access(access: crate::wgpu_types::StorageTextureAccess) -> u32 {
    match access {
        crate::wgpu_types::StorageTextureAccess::ReadOnly => glow::READ_ONLY,
        crate::wgpu_types::StorageTextureAccess::WriteOnly => glow::WRITE_ONLY,
        crate::wgpu_types::StorageTextureAccess::ReadWrite => glow::READ_WRITE,
    }
}
